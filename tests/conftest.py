...
_NUTTI_ENV_VARS: tuple[str, ...] = (
    ...
    "NUTTI_VEO_FAL_PUNCH_IN_PERIOD_SEC",
    "NUTTI_REJECT_REASON_TIMEOUT_SEC",
    "NUTTI_CAPTION_BURN",
    "NUTTI_CAPTION_FONT",
    ...
    "NUTTI_VIDEO_BACKEND",
    "NUTTI_SEEDANCE_MODEL",
    "NUTTI_SEEDANCE_RESOLUTION",
    "NUTTI_SEEDANCE_TTS_MODEL",
    "NUTTI_SEEDANCE_TTS_VOICE",
    "NUTTI_SEEDANCE_TTS_VOICE_INSTRUCTION",
    "NUTTI_SEEDANCE_TTS_PITCH",
